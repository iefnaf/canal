...
public class MysqlBinlogParsePerformanceTest {
  ...
  public static void consumer(BlockingQueue<LogBuffer> buffer)
  ...
  private static void sendBinlogDump(MysqlConnector connector, String binlogfilename,
      Long binlogPosition, int slaveId)
      throws IOException {
  ...
  public static void parseOneRow(RowsLogEvent event, RowsLogBuffer buffer, BitSet cols,
      boolean isAfter)
