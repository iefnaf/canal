...
public class FastsqlSchemaTest {
  ...
  public void testSimple() throws Throwable {
    ...
    String sql2 =
        " CREATE TABLE IF NOT EXISTS `table_x1` ( `id` bigint(20) NOT NULL AUTO_INCREMENT,"
  ...
  public void test_invisible() throws Throwable {
    SchemaRepository repository = new SchemaRepository(JdbcConstants.MYSQL);
    String sql =
        " CREATE TABLE `proposal_order_info` (`id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,"
            + "`created_at` timestamp NULL DEFAULT NULL, " + "PRIMARY KEY (`id`) , "
