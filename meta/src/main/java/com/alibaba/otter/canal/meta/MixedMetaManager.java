...
public class MixedMetaManager extends MemoryMetaManager implements CanalMetaManager {
  ...
  public void start() {
    ...
    destinations = MigrateMap.makeComputingMap(
        destination -> zooKeeperMetaManager.listAllSubscribeInfo(destination));
  ...
  public void addBatch(final ClientIdentity clientIdentity, final PositionRange positionRange,
      final Long batchId)
      throws CanalMetaManagerException {
