...
public class JdbcTypeUtil {
  ...
  public static Object getRSData(ResultSet rs, String columnName, int jdbcType)
      throws SQLException {
  ...
  public static Object typeConvert(String tableName, String columnName, String value, int sqlType,
      String mysqlType) {
    if (value == null
        || (value.equals("") && !(isText(mysqlType) || sqlType == Types.CHAR
    ...
    try {
      ...
      switch (sqlType) {
        ...
        case Types.TINYINT:
          ...
          break;
        case Types.BIGINT:
          if (mysqlType != null && mysqlType.startsWith("bigint") && mysqlType.endsWith(
              "unsigned")) {
      ...
      logger.error("table: {} column: {}, failed convert type {} to {}", tableName, columnName,
          value, sqlType);
      return value;
    }
  }
