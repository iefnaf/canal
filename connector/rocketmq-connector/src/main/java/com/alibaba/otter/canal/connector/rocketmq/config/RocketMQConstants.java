...
public class RocketMQConstants {
  ...
  public static final String ROCKETMQ_CUSTOMIZED_TRACE_TOPIC =
      ROOT + "." + "customized.trace.topic";
  ...
  public static final String ROCKETMQ_RETRY_TIMES_WHEN_SEND_FAILED =
      ROOT + "." + "retry.times.when.send.failed";
