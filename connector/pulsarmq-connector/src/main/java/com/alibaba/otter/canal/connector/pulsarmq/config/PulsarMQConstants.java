...
public class PulsarMQConstants {
   ...
   * 获取批量消息超时等待时间
   */
  public static final String PULSARMQ_GET_BATCH_TIMEOUT_SECONDS =
      ROOT + "." + "getBatchTimeoutSeconds";
  /**
   * 批量处理超时时间
   */
   ...
   * 重试间隔秒数
   */
  public static final String PULSARMQ_REDELIVERY_DELAY_SECONDS =
      ROOT + "." + "redeliveryDelaySeconds";
  /**
   * ACK超时秒数
   */
