...
public class CanalPulsarMQConsumer implements CanalMsgConsumer {
  ...
  public void init(Properties properties, String topic, String groupId) {
    ...
    String getBatchTimeoutSecondsStr = properties.getProperty(
        PulsarMQConstants.PULSARMQ_GET_BATCH_TIMEOUT_SECONDS);
    ...
    String batchProcessTimeoutStr = properties.getProperty(
        PulsarMQConstants.PULSARMQ_BATCH_PROCESS_TIMEOUT);
    if (StringUtils.isNotEmpty(batchProcessTimeoutStr)) {
      this.batchProcessTimeout = Integer.parseInt(batchProcessTimeoutStr);
    }
    String redeliveryDelaySecondsStr = properties.getProperty(
        PulsarMQConstants.PULSARMQ_REDELIVERY_DELAY_SECONDS);
    ...
    String ackTimeoutSecondsStr = properties.getProperty(
        PulsarMQConstants.PULSARMQ_ACK_TIMEOUT_SECONDS);
    ...
    String isRetryDLQUpperCaseStr = properties.getProperty(
        PulsarMQConstants.PULSARMQ_IS_RETRY_DLQ_UPPERCASE);
    if (StringUtils.isNotEmpty(isRetryDLQUpperCaseStr)) {
      this.isRetryDLQUpperCase = Boolean.parseBoolean(isRetryDLQUpperCaseStr);
    }
    String maxRedeliveryCountStr = properties.getProperty(
        PulsarMQConstants.PULSARMQ_MAX_REDELIVERY_COUNT);
