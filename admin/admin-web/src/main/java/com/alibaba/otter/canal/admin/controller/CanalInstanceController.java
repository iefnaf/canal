...
public class CanalInstanceController {
  ...
  public BaseModel<String> save(@RequestBody CanalInstanceConfig canalInstanceConfig,
  ...
  public BaseModel<String> update(@RequestBody CanalInstanceConfig canalInstanceConfig,
      @PathVariable String env) {
  ...
  public BaseModel<Boolean> start(@PathVariable Long id, @PathVariable Long nodeId,
      @PathVariable String env) {
  ...
  public BaseModel<Boolean> stop(@PathVariable Long id, @PathVariable Long nodeId,
      @PathVariable String env) {
  ...
  public BaseModel<Map<String, String>> instanceLog(@PathVariable Long id,
  ...
  public BaseModel<List<CanalInstanceConfig>> activeInstances(@PathVariable Long serverId,
      @PathVariable String env) {
