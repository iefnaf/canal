...
public class SyncUtil {
  ...
  public static Map<String, String> getColumnsMap(MappingConfig.DbMapping dbMapping,
   ...
   * @param i     索引号
   */
  public static void setPStmt(int type, PreparedStatement pstmt, Object value, int i)
      throws SQLException {
    switch (type) {
      case Types.BIT:
      case Types.BOOLEAN:
