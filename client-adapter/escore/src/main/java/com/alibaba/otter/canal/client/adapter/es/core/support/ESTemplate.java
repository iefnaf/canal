...
public interface ESTemplate {
   ...
   * @param esFieldData 数据Map
   */
  void updateByQuery(ESSyncConfig config, Map<String, Object> paramsTmp,
  ...
  Object getESDataFromRS(ESMapping mapping, ResultSet resultSet, Map<String, Object> esFieldData)
      throws SQLException;
  ...
  Object getValFromData(ESMapping mapping, Map<String, Object> dmlData, String fieldName,
      String columnName);

  Object getESDataFromDmlData(ESMapping mapping, Map<String, Object> dmlData,
      Map<String, Object> esFieldData);

  Object getESDataFromDmlData(ESMapping mapping, String owner, Map<String, Object> dmlData,
