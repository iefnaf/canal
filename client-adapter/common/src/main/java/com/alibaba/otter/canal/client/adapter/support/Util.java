...
public class Util {
  ...
  public static Object sqlRS(DataSource ds, String sql, List<Object> values,
      Function<ResultSet, Object> fun) {
    try (Connection conn = ds.getConnection()) {
  ...
  public static File getConfDirPath(String subConf) {
    ...
    if (path != null) {
      file = new File(
          path + ".." + File.separator + Constant.CONF_DIR + File.separator
