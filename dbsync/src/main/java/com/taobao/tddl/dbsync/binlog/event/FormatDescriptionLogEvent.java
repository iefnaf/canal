...
public final class FormatDescriptionLogEvent extends StartLogEventV3 {
  ...
  public static final int ST_COMMON_HEADER_LEN_OFFSET = (ST_SERVER_VER_OFFSET + ST_SERVER_VER_LEN
      + 4);
  ...
  public static final int FORMAT_DESCRIPTION_HEADER_LEN = (START_V3_HEADER_LEN + 1
      + LOG_EVENT_TYPES);
  ...
  public static final int EXECUTE_LOAD_QUERY_HEADER_LEN = (QUERY_HEADER_LEN
  ...
  public static final long checksumVersionProduct =
      (checksumVersionSplit[0] * 256 + checksumVersionSplit[1])
  ...
  public FormatDescriptionLogEvent(LogHeader header, LogBuffer buffer,
    ...
    numberOfEventTypes =
        buffer.limit() - (LOG_EVENT_MINIMAL_HEADER_LEN + ST_COMMON_HEADER_LEN_OFFSET + 1);
  ...
  public static FormatDescriptionLogEvent getFormatDescription(final int binlogVersion)
      throws IOException {
