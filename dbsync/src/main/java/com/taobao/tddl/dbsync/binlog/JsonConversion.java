...
public class JsonConversion {
  ...
  private static Json_Value parse_array_or_object(Json_enum_type type, LogBuffer buffer, long len,
      boolean large,
      String charsetName) {
  ...
  public static class Json_Value {
    ...
    public Json_Value(Json_enum_type t, LogBuffer data, long element_count, long bytes,
        boolean large) {
      this.m_type = t;
      this.m_data = data;
    ...
    public StringBuilder toJsonString(StringBuilder buf, String charsetName) {
      switch (m_type) {
        ...
        case OPAQUE:
          ...
          } else if (m_field_type == LogEvent.MYSQL_TYPE_DATE
              || m_field_type == LogEvent.MYSQL_TYPE_DATETIME
