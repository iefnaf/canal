...
public final class RowsLogBuffer {
  ...
  public RowsLogBuffer(LogBuffer buffer, final int columnLen, String charsetName,
      int jsonColumnCount, boolean partial) {
    this.buffer = buffer;
   ...
   * Rows_log_event::print_verbose_one_row
   */
  public final Serializable nextValue(final String columName, final int columnIndex, final int type,
      final int meta) {
   ...
   */
  final Serializable fetchValue(String columnName, int columnIndex, int type, final int meta,
      boolean isBinary) {
    int len = 0;
