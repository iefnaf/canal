...
public class CanalStarter {
  ...
  public synchronized void start() throws Throwable {
    ...
    if (canalMQProducer != null) {
      ...
      String destinations = CanalController.getProperty(properties,
          CanalConstants.CANAL_DESTINATIONS);
    ...
    if (canalAdmin == null && StringUtils.isNotEmpty(port)) {
      ...
      logger.debug(
          "canal admin port:{}, canal admin user:{}, canal admin password: {}, canal ip:{}",
          port,
          user,
          passwd,
          ip);
