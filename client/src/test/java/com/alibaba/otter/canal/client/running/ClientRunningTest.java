...
public class ClientRunningTest extends AbstractZkTest {
  ...
  public void setUp() {
    ...
    zkclientx.createPersistent(ZookeeperPathUtils.getClientIdNodePath(this.destination, clientId),
        true);
  }
  ...
  private ClientRunningMonitor buildClientRunning(final CountDownLatch countLatch,
