...
public class RocketMQCanalConnector implements CanalMQConnector {
  ...
  public RocketMQCanalConnector(String nameServer, String topic, String groupName, String accessKey,
    ...
    this(nameServer, topic, groupName, accessKey, secretKey, batchSize, flatMessage,
        enableMessageTrace, customizedTraceTopic, accessChannel);
  ...
  public void connect() throws CanalClientException {
    ...
    if (null != accessKey && accessKey.length() > 0 && null != secretKey
        && secretKey.length() > 0) {
    ...
    rocketMQConsumer = new DefaultMQPushConsumer(groupName, rpcHook,
        new AllocateMessageQueueAveragely(), enableMessageTrace, customizedTraceTopic);
