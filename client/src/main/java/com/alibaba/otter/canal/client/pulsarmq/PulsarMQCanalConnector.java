...
public class PulsarMQCanalConnector implements CanalMQConnector {
   ...
   */
  public PulsarMQCanalConnector(boolean isFlatMessage, String serviceUrl, String roleToken,
      String topic
  ...
  public PulsarMQCanalConnector(boolean isFlatMessage, String serviceUrl, String roleToken,
      ...
      int batchProcessTimeoutSeconds
      , int redeliveryDelaySeconds, int ackTimeoutSeconds, boolean isRetry,
      boolean isRetryDLQUpperCase
